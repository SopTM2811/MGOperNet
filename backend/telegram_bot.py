...
NC_MANUAL_NUM_COMPROBANTES, NC_MANUAL_MONTO_TOTAL, NC_MANUAL_ELEGIR_BENEFICIARIO, NC_MANUAL_CAPTURAR_BENEFICIARIO, NC_MANUAL_CAPTURAR_CLABE, NC_MANUAL_GUARDAR_FRECUENTE, NC_MANUAL_NUM_LIGAS = range(30, 37)
